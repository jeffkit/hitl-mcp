...
class TestForwardClient:
    ...
    async def test_get_forward_service_status_no_url(self):
        """测试没有配置 URL 时获取状态"""
        from hil_server.handlers.forward_client import get_forward_service_status
        
        with patch('hil_server.handlers.forward_client.config') as mock_config:
    ...
    async def test_get_forward_service_status_direct_mode(self):
        ...
        with patch('hil_server.handlers.forward_client.config') as mock_config, \
             patch('hil_server.handlers.forward_client.httpx.AsyncClient') as mock_client_class:
...
class TestForwardServiceLogs:
    ...
    async def test_get_forward_service_logs_success(self):
        """测试成功获取日志"""
        from hil_server.handlers.forward_client import get_forward_service_logs
...
class TestForwardServiceRules:
    ...
    async def test_add_forward_rule_no_url(self):
        """测试没有配置 URL 时添加规则"""
        from hil_server.handlers.forward_client import add_forward_rule, ForwardRule
    ...
    async def test_update_forward_rule_success(self):
        """测试成功更新规则"""
        from hil_server.handlers.forward_client import update_forward_rule, ForwardRule
    ...
    async def test_delete_forward_rule_success(self):
        """测试成功删除规则"""
        from hil_server.handlers.forward_client import delete_forward_rule
...
class TestForwardServiceConfig:
    ...
    async def test_get_forward_service_config_success(self):
        """测试成功获取配置"""
        from hil_server.handlers.forward_client import get_forward_service_config
    ...
    async def test_reload_forward_service_config_success(self):
        """测试成功重新加载配置"""
        from hil_server.handlers.forward_client import reload_forward_service_config
